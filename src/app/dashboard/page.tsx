...
export default function Dashboard() {
 ...
 <Link href="/" className="text-sm hover:underline border border-[#33ff00] px-4 py-1 terminal-btn ">
 [ LOGOUT ]
 </Link>
 </header>
 ...
 <div className="protocol-card border border-[#33ff00] p-3 transition-colors cursor-pointer">
